...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        mySwitch.center = CGPoint(x: view.bounds.size.width * 0.5, y: view.bounds.size.height * 0.5)
        ...
        mySwitch2.center = CGPoint(x: view.bounds.size.width * 0.5, y: view.bounds.size.height * 0.5 - 80)
        ...
        mySwitch3.center = CGPoint(x: view.bounds.size.width * 0.5, y: view.bounds.size.height * 0.5 + 70)
        mySwitch3.addTarget(self, action: #selector(ViewController.switchChanged(_:)), for: UIControlEvents.valueChanged)
        view.addSubview(mySwitch3)
